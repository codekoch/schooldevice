...
rsync -a  --exclude-from=rsync-homedir-local.txt --progress /home/user0/ $path/ --delete | su user0 -c 'zenity --title "Session" --text "Saving...(Please wait for Ok Button)" --progress --pulsate --auto-kill'
