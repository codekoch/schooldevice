...
rsync -a  --exclude-from=rsync-homedir-local.txt --progress $path/ /home/user0/ --delete | su user0 -c 'zenity --title "Session" --text "Loading...(Please wait for Ok Button)" --progress --pulsate --auto-kill'
